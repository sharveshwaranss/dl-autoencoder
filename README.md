...
# Print model summary
print("Name:ASWIN L")
print("Register Number:212224230028")
summary(model, input_size=(1, 28, 28))

# Train the autoencoder
def train(model, loader, criterion, optimizer, epochs=5):
    model.train()
    print("Name:SHARVESHWARAN SS")
    print("Register Number:212224220096")
...
### Model Summary
<img width="663" height="477" alt="image" src="https://github.com/user-attachments/assets/be20db69-4f7f-4a32-812d-9401f02f3572" />




### Training loss
<img width="404" height="203" alt="image" src="https://github.com/user-attachments/assets/aaf230aa-ab02-402d-a305-39055a015f57" />


## Original vs Noisy Vs Reconstructed Image
<img width="1721" height="609" alt="image" src="https://github.com/user-attachments/assets/9f1f976c-5752-4499-a348-54e8fe0540f1" />
